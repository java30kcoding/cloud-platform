...
public class CourseEsSearchController {
     ...
     */
    @PostMapping("save")
    public String add(@RequestBody CourseDocument courseDocument) {
        esSearchService.save(courseDocument);
        return "success";
    }
     ...
     */
    @GetMapping("get/{id}")
    public CourseDocument getById(@PathVariable String id){
    ...
    public List<CourseDocument> query(@PathVariable String keyword){
        return esSearchService.query(keyword,CourseDocument.class);
    }
